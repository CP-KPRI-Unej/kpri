    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden p-6">
        <form id="bannerForm" enctype="multipart/form-data">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div id="image-preview-container" class="mt-3 hidden">
                            <img id="image-preview" class="max-h-32 max-w-full rounded border border-gray-300 dark:border-gray-600">
                        </div>
            ...
            <div class="mt-6 flex justify-end space-x-3">
                ...
                <button type="button" id="submitBtn" class="px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 transition">Simpan Banner</button>
            </div>
        </form>
    </div>
</div>
