        ...
        <div class="flex-1 overflow-y-auto">
            <nav class="px-4 py-2 space-y-1">
                ...
                <a href="{{ route('admin.dashboard') }}"
                    class="flex items-center px-4 py-3 text-sm font-medium rounded-md {{ request()->routeIs('admin.dashboard') ? 'bg-white text-orange-500 dark:bg-gray-700 dark:text-gray-100' : 'text-white/80 hover:bg-white/10 hover:text-white dark:hover:bg-gray-700' }}">
                ...
                <a href="{{ route('admin.artikel.index') }}"
                    class="flex items-center px-4 py-3 text-sm font-medium rounded-md {{ request()->routeIs('admin.artikel.*') ? 'bg-white text-orange-500 dark:bg-gray-700 dark:text-gray-100' : 'text-white/80 hover:bg-white/10 hover:text-white dark:hover:bg-gray-700' }}">
                ...
                <a href="{{ route('admin.struktur.index') }}"
                    class="flex items-center px-4 py-3 text-sm font-medium rounded-md {{ request()->routeIs('admin.struktur.*') ? 'bg-white text-orange-500 dark:bg-gray-700 dark:text-gray-100' : 'text-white/80 hover:bg-white/10 hover:text-white dark:hover:bg-gray-700' }}">
                ...
                <a href="{{ route('admin.download.index') }}"
                    class="flex items-center px-4 py-3 text-sm font-medium rounded-md {{ Request::is('admin/download*') ? 'bg-white text-orange-500 dark:bg-gray-700 dark:text-gray-100' : 'text-white/80 hover:bg-white/10 hover:text-white dark:hover:bg-gray-700' }}">
                ...
                <div x-data="{ open: {{ request()->routeIs('admin.produk.*') || request()->routeIs('admin.promo.*') || request()->routeIs('admin.kategori.*') ? 'true' : 'false' }} }" class="relative">
                    ...
                    <div x-show="open" class="pl-4 mt-1 space-y-1">
                        <a href="{{ route('admin.produk.index') }}"
                            class="flex items-center px-4 py-2 text-sm font-medium rounded-md {{ request()->routeIs('admin.produk.*') ? 'bg-white text-orange-500 dark:bg-gray-700 dark:text-gray-100' : 'text-white/80 hover:bg-white/10 hover:text-white dark:hover:bg-gray-700' }}">
                            <i class="bi bi-circle-fill mr-3 text-[8px]"></i>
                            <span>Produk</span>
                        </a>
                        <a href="{{ route('admin.promo.index') }}"
                            class="flex items-center px-4 py-2 text-sm font-medium rounded-md {{ request()->routeIs('admin.promo.*') ? 'bg-white text-orange-500 dark:bg-gray-700 dark:text-gray-100' : 'text-white/80 hover:bg-white/10 hover:text-white dark:hover:bg-gray-700' }}">
                            <i class="bi bi-circle-fill mr-3 text-[8px]"></i>
                            <span>Promo</span>
                        </a>
                        <a href="{{ route('admin.kategori.index') }}"
                            class="flex items-center px-4 py-2 text-sm font-medium rounded-md {{ request()->routeIs('admin.kategori.*') ? 'bg-white text-orange-500 dark:bg-gray-700 dark:text-gray-100' : 'text-white/80 hover:bg-white/10 hover:text-white dark:hover:bg-gray-700' }}">
                            <i class="bi bi-circle-fill mr-3 text-[8px]"></i>
                            <span>Kategori</span>
                        </a>
                    </div>
                ...
                <div x-data="{ open: {{ request()->routeIs('admin.layanan.*') || request()->routeIs('admin.hero-banners.*') ? 'true' : 'false' }} }" class="relative">
                    ...
                    <div x-show="open" class="pl-4 mt-1 space-y-1" id="layanan-menu">
                        ...
                        <a href="{{ route('admin.hero-banners.index') }}"
                            class="flex items-center px-4 py-2 text-sm font-medium rounded-md {{ request()->routeIs('admin.hero-banners.*') ? 'bg-white text-orange-500 dark:bg-gray-700 dark:text-gray-100' : 'text-white/80 hover:bg-white/10 hover:text-white dark:hover:bg-gray-700' }}">
                ...
                <a href="{{ route('admin.galeri.index') }}"
                    class="flex items-center px-4 py-3 text-sm font-medium rounded-md {{ request()->routeIs('admin.galeri.*') ? 'bg-white text-orange-500 dark:bg-gray-700 dark:text-gray-100' : 'text-white/80 hover:bg-white/10 hover:text-white dark:hover:bg-gray-700' }}">
                ...
                <a href="{{ route('admin.faq.index') }}"
                    class="flex items-center px-4 py-3 text-sm font-medium rounded-md {{ request()->routeIs('admin.faq.*') ? 'bg-white text-orange-500 dark:bg-gray-700 dark:text-gray-100' : 'text-white/80 hover:bg-white/10 hover:text-white dark:hover:bg-gray-700' }}">
                ...
                <a href="{{ route('admin.notification.index') }}"
                    class="flex items-center px-4 py-3 text-sm font-medium rounded-md {{ request()->routeIs('admin.notifications.*') ? 'bg-white text-orange-500 dark:bg-gray-700 dark:text-gray-100' : 'text-white/80 hover:bg-white/10 hover:text-white dark:hover:bg-gray-700' }}">
                ...
                <a href="{{ route('admin.settings.index') }}"
                    class="flex items-center px-4 py-3 text-sm font-medium rounded-md {{ request()->routeIs('admin.settings.*') ? 'bg-white text-orange-500 dark:bg-gray-700 dark:text-gray-100' : 'text-white/80 hover:bg-white/10 hover:text-white dark:hover:bg-gray-700' }}">
        ...
        <div class="p-4 border-t border-white/10 dark:border-gray-700">
            <div class="flex items-center">
                ...
                <button id="logout-button"
                    class="ml-auto p-1 text-white/70 hover:text-white dark:text-gray-400 dark:hover:text-white">
        ...
        fetch('/api/admin/layanan/jenis', {
            ...
            .then(data => {
                ...
                jenisLayanans.forEach(jenis => {
                    ...
                    menuItem.href = '#';
                    menuItem.className =
                        `flex items-center px-4 py-2 text-sm font-medium rounded-md ${isActive ? 'bg-white text-orange-500 dark:bg-gray-700 dark:text-gray-100' : 'text-white/80 hover:bg-white/10 hover:text-white dark:hover:bg-gray-700'}`;
            ...
            .catch(error => {
                ...
                const menuContainer = document.getElementById('layanan-menu');
                menuContainer.innerHTML =
                    '<div class="text-center py-2 text-sm text-red-300">Gagal memuat data</div>';
            });
