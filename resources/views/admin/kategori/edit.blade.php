...
<div class="container-fluid px-4 py-4 mx-auto">
    ...
    <div class="bg-white dark:bg-gray-800 shadow rounded-lg overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700">
            <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100">Form Edit Kategori: <span class="text-indigo-600 dark:text-indigo-400">{{ $kategori->kategori }}</span></h3>
        </div>
        <div class="p-6">
            <form action="{{ route('admin.kategori.update', $kategori->id_kategori) }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" class="w-full px-3 py-2 border {{ $errors->has('kategori') ? 'border-red-500 dark:border-red-500' : 'border-gray-300 dark:border-gray-600' }} rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-white" 
                        id="kategori" name="kategori" value="{{ old('kategori', $kategori->kategori) }}" required maxlength="30" autofocus
