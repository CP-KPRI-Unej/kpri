    ...
    <article class="py-12 bg-white dark:bg-gray-900">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="max-w-4xl mx-auto">
                ...
                <div class="mb-8">
                    <img src="{{ asset('images/hero.png') }}" alt="KPRI UNEJ Building"
                ...
                <div class="prose prose-lg max-w-none dark:prose-invert mb-12">
                    <div class="text-gray-700 dark:text-gray-300 leading-relaxed space-y-6">
                        <p>
                            ...
                            percontohan terbaik di Indonesia yang telah berdiri sejak 1979. Dengan layanan simpan pinjam,
                            toko kebutuhan harian, dan pengelolaan yang profesional serta transparan, KPRI UNEJ berhasil
                            meraih berbagai penghargaan nasional dan menjadi inspirasi bagi koperasi lain.
                        </p>

                        <p>
                            Didukung penuh oleh civitas akademika Universitas Jember, koperasi ini terus berinovasi dan
                            berkembang sebagai koperasi modern yang mengedepankan kesejahteraan anggota dan semangat gotong
                            royong.
                        </p>

                        <p>
                            Kegiatan ini di adakan di dalam SOMBRA Universitas Jember dengan menghadirkan 100 dan pembicara
                            materi yaitu perkembangan terkini dari Kementerian Koperasi dan UKM RI, Koperasi dan UKM
                            Provinsi Jawa Timur, dan Koperasi dan UKM Kabupaten Jember. Kegiatan ini bertujuan untuk
                            meningkatkan kapasitas pengelola KPRI UNEJ dalam mengelola koperasi yang mandiri dan berkelas.
                        </p>

                        <p>
                            Berbagai kegiatan yang dilakukan antara lain pelatihan manajemen koperasi, pelatihan keuangan
                            koperasi, dan pelatihan teknologi informasi. Semua kegiatan ini diharapkan dapat meningkatkan
                            kualitas pelayanan KPRI UNEJ kepada anggotanya dan menjadikan KPRI UNEJ sebagai koperasi yang
                ...
                <div class="border-t border-gray-200 dark:border-gray-700 pt-6 mb-12">
                    <div class="flex flex-wrap items-center">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <span
                                class="inline-block bg-amber-100 dark:bg-amber-900 text-amber-800 dark:text-amber-200 text-xs px-3 py-1 rounded-full">KPRI
                                UNEJ</span>
                            <span
                                class="inline-block bg-amber-100 dark:bg-amber-900 text-amber-800 dark:text-amber-200 text-xs px-3 py-1 rounded-full">Koperasi</span>
                            <span
                                class="inline-block bg-amber-100 dark:bg-amber-900 text-amber-800 dark:text-amber-200 text-xs px-3 py-1 rounded-full">Pelatihan</span>
                            <span
                                class="inline-block bg-amber-100 dark:bg-amber-900 text-amber-800 dark:text-amber-200 text-xs px-3 py-1 rounded-full">Kapasitas</span>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="flex items-start space-x-4">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-gray-700 dark:text-gray-300 leading-relaxed">
                                    Artikelnya sangat bermanfaat karena kita bisa mengetahui info info terbaru tentang KPRI
                                    UNEJ
                                </p>
                            </div>
                        </div>
                ...
                <div class="bg-white dark:bg-gray-700 rounded-lg p-6 shadow-sm">
                    ...
                    <form id="comment-form" class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea id="content" name="content" rows="4" placeholder="Keren sekali KPRI, Maju Terus!!!"
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <article
                        ...
                        <div class="p-6">
                            ...
                            <a href="#"
                                class="inline-block bg-amber-500 hover:bg-amber-600 text-white text-sm font-medium py-2 px-4 rounded-md transition duration-300">
                                Baca Selengkapnya
                            </a>
                        </div>
                    </article>
