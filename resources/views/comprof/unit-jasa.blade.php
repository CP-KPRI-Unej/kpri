        ...
        <section class="flex flex-col w-full justify-center pt-14 pb-3 text-center px-4 relative">
            <div class="w-full md:w-3/4 m-auto flex flex-col gap-4 dark:bg-gray-900 bg-white p-8 pb-4 rounded-lg">
                ...
                <div class="flex flex-col md:flex-row gap-8">
                    ...
                    <ol class="list-decimal text-sm text-justify text-black dark:text-white mt-5 space-y-1">
        ...
        <section class="flex flex-col justify-center pt-3 pb-10 text-center px-4 relative">
            <div class="w-full md:w-3/4 m-auto flex flex-col gap-4 dark:bg-gray-900 bg-white p-8 rounded-lg">
                ...
                <p class="text-sm text-justify text-black dark:text-white">
                    Koperasi KPRI UNEJ juga menyediakan layanan sewa atau rental kendaraan untuk umum dan anggota (khusus
                    anggota akan mendapatkan harga sewa khusus).
                    Armada yang tersedia saat ini adalah 2 unit Toyota Hi-Ace (termasuk sopir).
                    Selain layanan rental kendaraan, Koperasi KPRI UNEJ juga mempunyai tempat/lapak Pujasera yang disewakan
                    untuk umum dan anggota.
